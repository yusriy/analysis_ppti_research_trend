...
Each folder preserves the report edition that was current before the next completed-month update replaced it. The publication strategy archive also includes its canonical analytical artifact for reproducibility.
