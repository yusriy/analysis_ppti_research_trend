...
author: 
  - name: "Yusri Yusup"
  - name: "Wan Zafira Wan Zakaria"
  - name: "Lee Chee Keong"
  - name: "Norli Ismail"
  - name: "Abdorezza Mohammad Nafchi"
  - name: "Mohd Nurazzi Norizan"
  - name: "Melbi Mahardika"
...
- A focused set of journals consistently accepts PPTI work
- Several outlets demonstrate both **high publication frequency** and **strong citation visibility**
- Open-access and hybrid journals feature prominently, supporting funder mandates
...
### Total Target Journals: **`r total_journals`**  
### Total PPTI Contributors: **`r total_authors`**
    ...
    tags$div(class = "card stat-card",
      tags$div(class = "card-body",
        tags$div(class = "d-flex justify-content-between align-items-start",
          ...
          tags$span(class = "badge badge-pill",
                    style = "background:rgba(236,72,153,.12); color:#9d174d;", "🗓️")
        )
      )
    )
  )
